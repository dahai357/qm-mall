        ...
        <div v-show="this.subData.type>0"  class="ncsc-form-default">
            ...
            <template v-else>
                ...
                <dl id="gift_coupon_dl" :style="{display: subData.coupon_type==2?'table':'none'}">
                    ...
                    <dd>
                        ...
                        <template v-if="avail_coupon_list&&avail_coupon_list.length>0">
                            <p class="hint vital">满额赠券活动的优惠券必须满足<span class="c-black">“前台不展示”</span><span class="c-black">“不限制发布张数”</span><span class="c-black">“允许领用多张”</span>;</p>
                        </template>
                        <template v-else>
                            <p class="c-gray">
                                没有可选择的优惠券，用于满额赠券活动的优惠券必须满足<span class="c-black">“前台不展示”</span><span class="c-black">“不限制发布张数”</span><span class="c-black">“允许领用多张”</span>;<br/><a @click="addNewCoupon()" class="c-orange" target="_blank">前往配置 &raquo;</a></p>
                        </template>
                    </dd>
                </dl>
                <dl id="gift_goods_dl" :style="{display: subData.coupon_type==3?'table':'none'}">
                    <dt><i class="required">*</i>满额赠礼品:</dt>
                    <dd>
            ...
            <dl>
                ...
                <dd>
                    <ul class="ncsc-form-radio-list">
                        <li>
                            <input type="radio" name="is_show" value="1" id="is_show_1" v-model="subData.is_show" disabled>
                            <label for="is_show_1">展示</label>
                        </li>
                        <li>
                            <input type="radio" name="is_show" value="0" id="is_show_0" v-model="subData.is_show" disabled>
            ...
            <dl>
                ...
                <dd>
                    <ul class="ncsc-form-radio-list">
                        <li>
                            <input type="radio" name="is_limit_num" value="0" id="is_limit_num_0" v-model="subData.is_limit_num" disabled/>
                            <label for="is_limit_num_0">限制</label>
                        </li>
                        <li>
                            <input type="radio" name="is_limit_num" value="1" id="is_limit_num_1" v-model="subData.is_limit_num" disabled />
            ...
            <dl>
                ...
                <dd>
                    <ul class="ncsc-form-radio-list">
                        <li>
                            <input type="radio" name="is_overlay" value="1" id="is_overlay_1" v-model="subData.is_overlay" disabled />
                            <label for="is_overlay_1">允许</label>
                        </li>
                        <li>
                            <input type="radio" name="is_overlay" value="0" id="is_overlay_0" v-model="subData.is_overlay" disabled />
            ...
            <dl>
                ...
                <dd>
                    <ul class="ncsc-form-radio-list">
                        <li>
                            <input type="radio" name="is_available" value="1" id="is_available_1" v-model="subData.is_available" disabled/>
                            <label for="is_available_1">是</label>
                        </li>
                        <li>
                            <input type="radio" name="is_available" value="0" id="is_available_0" v-model="subData.is_available" disabled/>
    ...
    export default {
        ...
        methods: {
            ...
            goodsDetail(item){
              ...
              this.$router.push({name:'store_goods_add_step_two',params:{commonId:item.goods_commonid}})
            },
            goNext(){
            ...
            removeOneGift(goods){
                this.updateGiftGoods(goods.goods_commonid)
            },
            removeOneGiftGoods(event){
                this.updateGiftGoods(event.good.goods_commonid)
            },
            updateGiftGoods(goods_commonid){
            ...
            submit(){
                ...
                if(this.subData.coupon_type==0){
                    ...
                    if(this.subData.cash_money>=this.subData.order_amount){
                ...
                if(this.subData.effective_days){
                ...
                if(validRes) {
                    ...
                    storeCoupon.editCoupon(data).then((res) => {
                        if(res.resultCode == 1){
                            ...
                            oldCoupon.gift_coupon_id = res.responseContent
                            storage.set('oldCoupon',oldCoupon)
